		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑交流论坛</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">交流论坛管理</li>
								<li class="breadcrumb-item active">编辑交流论坛</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">交流论坛信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										<div class="form-group col-md-6">
										<label>帖子标题</label>
										<input id="title" name="title" class="form-control" placeholder="帖子标题">
									</div>
													<div class="form-group col-md-6">
										<label>父节点id</label>
										<input id="parentid" name="parentid" class="form-control" placeholder="父节点id">
									</div>
											<div class="form-group col-md-6">
										<label>用户id</label>
										...
										<input id="username" name="username" class="form-control" placeholder="用户名">
											...
											<div class="form-group col-md-6">
										<label>状态</label>
										<select id="isdoneSelect" name="isdone" class="form-control">
																						<option value=" "></option>
																																					<option class="isdoneOption" value="开放">
														开放
													</option>
																										<option class="isdoneOption" value="关闭">
														关闭
													</option>
																																			</select>	
									</div>	
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#title").val(ruleForm.title);	
																...
																var isdoneOptions = document.getElementsByClassName("isdoneOption");
					for(var isdoneCount = 0; isdoneCount < isdoneOptions.length;isdoneCount++){
						if(isdoneOptions[isdoneCount].getAttribute('value') == ruleForm.isdone){
							isdoneOptions[isdoneCount].setAttribute('selected','selected');
						}
					}
									}		
		//图片显示
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.parentid != null && res.data.parentid != ''){
												...
												if(res.data != null && res.data != '' && res.data.username != null && res.data.username != ''){

																							$("#username").val(res.data.username);
																					}
												if(res.data != null && res.data != '' && res.data.isdone != null && res.data.isdone != ''){

															var isdoneOptions = document.getElementsByClassName("isdoneOption");
								for(var isdoneCount = 0; isdoneCount < isdoneOptions.length;isdoneCount++){
									if(isdoneOptions[isdoneCount].getAttribute('value') == res.data.isdone){
										isdoneOptions[isdoneCount].setAttribute('selected','selected');
									}
								}
													}
