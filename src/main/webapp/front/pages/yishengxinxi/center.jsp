				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
							...
							<div class="layui-input-block">
								<select name="xingbie" id="xingbie">
									...
									<option v-for="(item,index) in xingbie" v-bind:key="index" :value="item">{{item}}</option>
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">医龄</label>
							<div class="layui-input-block">
								<input type="text" name="yiling" id="yiling" placeholder="医龄" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yuyuefeiyong" id="yuyuefeiyong" placeholder="预约费用" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">赞</label>
							<div class="layui-input-block">
								<input type="text" name="thumbsupnum" id="thumbsupnum" placeholder="赞" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">踩</label>
							<div class="layui-input-block">
								<input type="text" name="crazilynum" id="crazilynum" placeholder="踩" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
