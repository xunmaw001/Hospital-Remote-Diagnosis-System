		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">在线咨询管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">在线咨询列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">在线咨询列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('userid')">用户id<i id="useridIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('adminid')">管理员id<i id="adminidIcon" class="fa fa-sort"></i></th>
																																																			
																													<th>提问</th>
																																																																	
																													<th>回复</th>
																																																																	<th onclick="sort('isreply')">是否回复<i id="isreplyIcon" class="fa fa-sort"></i></th>
																																					<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
							...
							var useridCell  = document.createElement('td');
									...
									row.appendChild(useridCell);
				            				var adminidCell  = document.createElement('td');
												 ...
												 adminidCell.innerHTML = item.adminid;
				  	...
				  	replyCell.innerHTML = item.reply;
									...
									row.appendChild(replyCell);
				            				var isreplyCell  = document.createElement('td');
												 ...
												 isreplyCell.innerHTML = item.isreply;
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chat/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
