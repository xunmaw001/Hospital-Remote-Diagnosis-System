		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑医生信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑医生信息</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医生信息信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<select id="xingbieSelect" name="xingbie" class="form-control">
											...
											<div class="form-group col-md-6">
										<label>医龄</label>
										<input id="yiling" name="yiling" class="form-control" placeholder="医龄">
									</div>
											<div class="form-group col-md-6">
																				<label>头像</label>
										...
										<input name="touxiang" id="touxiang-input" type="hidden">
													...
													<div class="form-group col-md-6">
										<label>预约费用</label>
										<input id="yuyuefeiyong" name="yuyuefeiyong" class="form-control" placeholder="预约费用">
									</div>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yishengxinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yishengxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yishengxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
					...
					for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
						if(xingbieOptions[xingbieCount].getAttribute('value') == ruleForm.xingbie){
							xingbieOptions[xingbieCount].setAttribute('selected','selected');
																...
																$("#yuyuefeiyong").val(ruleForm.yuyuefeiyong);	
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#touxiang-input").val(res.data.touxiang);
												...
												if(res.data != null && res.data != '' && res.data.yuyuefeiyong != null && res.data.yuyuefeiyong != ''){

																							$("#yuyuefeiyong").val(res.data.yuyuefeiyong);
																					}
